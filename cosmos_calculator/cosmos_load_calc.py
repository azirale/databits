...
raw_json_bytes = get_raw_json_bytes(YOUR_COMPLETE_LOAD_PYSPARK_DATAFRAME_HERE)
...
print(f"Raw JOSN size is {raw_json_bytes:,} bytes")
print(f"This converts to approx {cosmos_stored_gb:,.1f} GB - per cosmos RU/s/GB calculation")
print(f"Minimum provisioned RUI will be approx {suggest_min_provisioned:,} RU/s")
